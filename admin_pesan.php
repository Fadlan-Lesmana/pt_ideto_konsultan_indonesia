                    ...
                    <table style="width: 100%; border-collapse: collapse; text-align: left;">
                        <thead>
                            <tr style="background-color: #1a7a43; color: white;">
                                ...
                                <th style="padding: 15px; border-bottom: 1px solid #ddd;">Waktu</th>
                                <th style="padding: 15px; border-bottom: 1px solid #ddd;">Nama Pengirim</th>
                                <th style="padding: 15px; border-bottom: 1px solid #ddd;">Kontak</th>
                                <th style="padding: 15px; border-bottom: 1px solid #ddd;">Isi Pesan</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            // Tambahkan tanda @ agar tidak error jika tabel belum dibuat
                            ...
                            <tr style="border-bottom: 1px solid #eee;">
                                ...
                                <td style="padding: 15px; vertical-align: top; font-weight: 500;"><?php echo $row['nama']; ?></td>
                                ...
                                <td style="padding: 15px; vertical-align: top;">
                                    <strong style="display: block; margin-bottom: 5px;"><?php echo $row['subjek']; ?></strong>
                            ...
                            <?php 
                                ...
                                echo "<tr><td colspan='6' style='padding: 30px; text-align: center; color: #888;'>Belum ada pesan masuk.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
